...
public class ConfigActivity extends AppCompatActivity {
    ...
    private void showManualConfig() {
        ...
        int lastPort = prefs.getInt("last_port", 3003);
        if (!lastIp.isEmpty()) {
    ...
    private void testAndSaveServer(String baseUrl) {
        ...
        new Thread(() -> {
            try {
                ...
                runOnUiThread(() -> {
                    Toast.makeText(this, getString(R.string.server_invalid), Toast.LENGTH_LONG).show();
                ...
                runOnUiThread(() -> {
                    Toast.makeText(this, getString(R.string.connection_failed) + ":\n" + e.getMessage(), Toast.LENGTH_LONG).show();
                    btnConnect.setEnabled(true);
                    btnUseFound.setEnabled(true);
                });
            }
